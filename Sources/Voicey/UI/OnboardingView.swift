...
struct OnboardingView: View {
        ...
        VStack(spacing: 0) {
            ...
            VStack(spacing: 12) {
                ...
                SetupStepRow(
                    ...
                    buttonTitle: isModelReady ? "Ready" : (isModelDownloading ? "Downloading..." : "Download"),
                ...
                SetupStepRow(
                    ...
                    buttonTitle: accessibilityGranted ? "Granted" : (isCheckingAccessibility ? "Checking..." : "Open Settings"),
    ...
    private func startModelDownloadIfNeeded() {
        ...
        guard !modelManager.isDownloaded(defaultModel),
              modelManager.isDownloading[defaultModel] != true else {
            return
        }
        
        debugPrint("📥 Auto-starting download of \(defaultModel.displayName) during onboarding", category: "ONBOARD")
...
struct SetupStepRow: View {
    ...
    var body: some View {
        HStack(spacing: 16) {
            ...
            ZStack {
                Circle()
                    .fill(isComplete ? Color.green.opacity(0.15) : (isInProgress ? Color.blue.opacity(0.15) : Color.gray.opacity(0.1)))
