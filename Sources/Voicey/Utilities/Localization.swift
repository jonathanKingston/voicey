...
enum L10n {
  ...
  static func string(_ key: String, _ args: CVarArg...) -> String {
    let format = NSLocalizedString(
      key, tableName: "Localizable", bundle: localizationBundle, comment: "")
    if args.isEmpty {
      return format
    }
  ...
  enum Transcription {
    ...
    static var screenContextOCREnable: String {
      L10n.string("transcription.screenContextOCREnable")
    }
    ...
    static var localLM: String { L10n.string("transcription.localLM") }
    static var localLMEnable: String { L10n.string("transcription.localLMEnable") }
    static var localLMDescription: String { L10n.string("transcription.localLMDescription") }
    static var localLMBaseURL: String { L10n.string("transcription.localLMBaseURL") }
    static var localLMBaseURLDescription: String {
      L10n.string("transcription.localLMBaseURLDescription")
    }
    static var localLMModelName: String { L10n.string("transcription.localLMModelName") }
    static var localLMModelNameDescription: String {
      L10n.string("transcription.localLMModelNameDescription")
    }
    static var glossaryDescriptionLocalLM: String {
      L10n.string("transcription.glossaryDescriptionLocalLM")
    }
    static var screenContextDescriptionLocalLM: String {
      L10n.string("transcription.screenContextDescriptionLocalLM")
    }
  }
  ...
  enum VoiceCommands {
    ...
    static func customText(_ text: String) -> String {
      L10n.string("voiceCommands.customText", text)
    }
  ...
  enum Advanced {
    ...
    static var pauseMediaDuringTranscription: String {
      L10n.string("advanced.pauseMediaDuringTranscription")
    }
