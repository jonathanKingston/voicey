...
**Automation assessment (Jun 2026, post-#168):** [#168](https://github.com/jonathanKingston/voicey/pull/168) adds the backlog-reconciler system design ([`backlog-reconciler-system-design.md`](explorations/backlog-reconciler-system-design.md)); it does **not** unblock new implementation PRs. Priority queue unchanged. **Cloud Agent cycle (this run):** rebased [#150](https://github.com/jonathanKingston/voicey/pull/150) onto `main` (mechanical conflict: integrate capture gate with post-#167 `qwenHints` Rust-only path; 8/8 `ScreenContextCaptureGateTests` pass on Linux) and [#169](https://github.com/jonathanKingston/voicey/pull/169) onto `main` (clean; 4/4 `UtteranceTranscriptionFinishPolicyTests` pass). Do **not** open duplicate PRs for #150 / #169 / #152 capture. Next tranche after #150 merge: [#152](https://github.com/jonathanKingston/voicey/issues/152) capture layer.
